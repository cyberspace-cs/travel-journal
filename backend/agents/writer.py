...
def write_journal(clips: list, mode: str = "deep"):
    ...
    【去 AI 味规则（来自 no-ai-slop）】
    - 禁用词：深刻、赋能、助力、打造、构建、砥砺、践行、赓续、擘画、绘就
    - 不要空泛的形容词："非常好"、"特别棒"、"超级治愈"——用具体的事来表现
    - 不要鸡汤结尾："今天也是美好的一天"、"旅行的意义就在这里"——直接结束就行
    - 不要每段都升华：写事实就好，让读者自己感受
    - 不要对称句式："不是...而是..."、"与其...不如..."——直接说是什么
    - 少用破折号，不要用太多
    - 不要总结式结尾："总之"、"总而言之"、"最后"
